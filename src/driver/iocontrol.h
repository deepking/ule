...
typedef struct {
    ...
    Dword				error;
    Byte				reserved[16];
} GetAcquireChannelRequest, *PGetAcquireChannelRequest;
...
typedef struct {
    ...
    Dword				error;
    Byte				reserved[16];
} GetInterruptsRequest, *PGetInterruptsRequest;

typedef struct {
    Interrupt			interrupt;
    Dword				error;
    Byte				reserved[16];
} ClearInterruptRequest, *PClearInterruptRequest;
...
typedef struct {
    ...
    Dword				error;
    Byte				reserved[16];
} TxLoadIQTableRequest, *PTxLoadIQTableRequest;
...
#define IOCTL_ITE_DEMOD_GETMODULE_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_STANDARD + 0x25, SetModuleRequest)

#define IOCTL_ITE_DEMOD_GET_ACQUIRECHANNEL_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_STANDARD + 0x26, GetAcquireChannelRequest)
...
#define IOCTL_ITE_DEMOD_GETDEVICEMODE_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_STANDARD + 0x28, TxModeRequest)

#define IOCTL_ITE_DEMOD_SETDEVICEMODE_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_STANDARD + 0x29, TxModeRequest)
 ...
 * many stream type, therefore host have to choose one type before receive 
 * data.
 * Paramters:   SetStreamTypeRequest struct
 */
#define IOCTL_ITE_DEMOD_SETSTREAMTYPE_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_STANDARD + 0x33, SetStreamTypeRequest)
 ...
 * Post-Viterbi BER, Abort Count, Signal Presented Flag, Signal Locked Flag,
 * Signal Quality, Signal Strength, Delta-T for DVB-H time slicing.
 * Paramters:	GetInterruptsRequest struct
 */
#define IOCTL_ITE_DEMOD_GETINTERRUPTS_TX  \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_STANDARD + 0x36, GetInterruptsRequest)

/**
 * Get the statistic values of demodulator, it includes Pre-Viterbi BER,
 * Post-Viterbi BER, Abort Count, Signal Presented Flag, Signal Locked Flag,
 * Signal Quality, Signal Strength, Delta-T for DVB-H time slicing.
 * Paramters:	ClearInterruptRequest struct
 */
#define IOCTL_ITE_DEMOD_CLEARINTERRUPT_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_STANDARD + 0x37, ClearInterruptRequest)

/**
 * Get the statistic values of demodulator, it includes Pre-Viterbi BER,
 * Post-Viterbi BER, Abort Count, Signal Presented Flag, Signal Locked Flag,
 * Signal Quality, Signal Strength, Delta-T for DVB-H time slicing.
 * Paramters:	GetDatagramRequest struct
 */
#define IOCTL_ITE_DEMOD_GETDATAGRAM_TX \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_STANDARD + 0x38, GetDatagramRequest)
...
/**
 * Add PID to PID filter.
 * Paramters:	AddPidRequest struct
 */
#define IOCTL_ITE_DEMOD_ADDPID_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DVBT + 0x07, AddPidRequest)
 ...
 * Paramters:	RemovePidRequest struct
 */
#define IOCTL_ITE_DEMOD_REMOVEPID_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DVBT + 0x09, RemovePidRequest)

/**
 * Remove PID from PID filter.
 * Paramters:	RemovePidAtRequest struct
 */
#define IOCTL_ITE_DEMOD_REMOVEPIDAT_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DVBT + 0x0A, RemovePidAtRequest)
 ...
 * Paramters:	TxLoadIQTableRequest struct
 */
#define IOCTL_ITE_DEMOD_LOADIQTABLE_TX \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DVBT + 0x12, TxLoadIQTableRequest)
